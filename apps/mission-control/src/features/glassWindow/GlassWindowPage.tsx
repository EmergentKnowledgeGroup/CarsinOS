...
export function GlassWindowPage(props: {
  ...
  const [chatterExpanded, setChatterExpanded] = useState(false);
      ...
      <div className="mc-window-grid">
        ...
        <section className="mc-chatter-panel" aria-label="Office Chatter">
          ...
          <div className="mc-chatter-layout">
            ...
            return (
              <details
                className="mc-chatter-collapse"
                open={chatterExpanded}
                onToggle={(event) =>
                  setChatterExpanded(event.currentTarget.open)
                }
              >
                <summary>
                  {rooms.length} {rooms.length === 1 ? "room" : "rooms"}
                  {unreadRooms > 0
                    ? ` · ${unreadRooms} with unread notes`
                    : ""}
                </summary>
                {chatterBody}
              </details>
