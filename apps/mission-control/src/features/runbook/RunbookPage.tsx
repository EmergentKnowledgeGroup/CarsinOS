    ...
    <section className="mc-runbook-page mc-runbook-paged" data-testid="runbook-page">
      ...
      {viewMode === "browse" ? (
        <Surface
          ...
          headerRight={
            /* Only the ready surface offers the pin: an honest-state panel
               must not expose a door into a disabled or broken room. The pin
               rides the existing header so the detail keeps fitting the
            ...
            <div className="mc-strategy-inline-actions">
              ...
              <PinRoomToOffice roomId="history" />
            </div>
          }
        >
