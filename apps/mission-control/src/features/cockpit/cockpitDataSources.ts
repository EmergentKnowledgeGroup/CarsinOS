...
export const COCKPIT_DATA_SOURCES: CockpitDataSource[] = [
  ...
  },
  {
    ...
    responseShape: "object",
    sampleFields: ["service", "version", "open_circuit_breakers", "open_plugin_breakers"],
  },
  {
    id: "getJobsStatus",
  ...
  },
  {
    ...
    responseShape: "object",
    sampleFields: ["board", "columns", "cards"],
    params: [
      {
        key: "boardId",
        label: "Board",
  ...
  },
  {
    ...
    responseShape: "object",
    sampleFields: ["generated_at_ms", "next_up", "always_running", "jobs"],
  },
