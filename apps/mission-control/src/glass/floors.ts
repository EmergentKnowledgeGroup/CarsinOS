...
export const DEFAULT_FLOORS: FloorDef[] = [
  ...
  },
  {
    ...
    rooms: [
      ...
      // File locks shares the mail route with Directory / Front Desk; the
      // stable room id — not the route — owns its lamp, landing, and pin.
      { id: "locks", floorId: "basement", label: "File locks", route: "mail", blocks: ["locks"] },
      { id: "setup", floorId: "basement", label: "Setup", route: "connectors", blocks: ["setup"] },
      // Policy shares the connectors route like Setup; the stable room id
      // owns its lamp, landing, and pin, and connector availability never
      // gates it.
      { id: "policy", floorId: "basement", label: "Policy", route: "connectors", blocks: ["policy"] },
    ],
    defaultRoom: "setup",
  },
];
