...
export type AssistantDeskWorkItemStatus =
  | "needs_you"
  | "working"
  | "waiting"
  | "blocked"
...
export interface AssistantDeskSourceRef {
  source: "session" | "run" | "approval" | "codex_bridge" | (string & {});
  id: string;
  label?: string;
}

export interface AssistantDeskDeepLink {
  label: string;
  target: string;
  href: string;
}

export interface AssistantDeskWorkItemDetails {
  provider_label?: string | null;
  model_label?: string | null;
  workspace_label?: string | null;
  process_label?: string | null;
  bridge_status?: "online" | "offline" | "unknown" | string | null;
  diagnostic_summary?: string | null;
  source_health?: "fresh" | "slow" | "stale" | "unavailable" | string | null;
  last_error?: string | null;
}

export interface AssistantDeskWorkItem {
  id: string;
  kind: AssistantDeskWorkItemKind;
  bucket?: "needs_you" | "working" | "done_recently" | string;
  title: string;
  task_label: string;
  owner_label: string;
  status: AssistantDeskWorkItemStatus;
  ...
  source_refs: AssistantDeskSourceRef[];
  deep_links?: AssistantDeskDeepLink[];
  details: AssistantDeskWorkItemDetails;
  can_open_transcript: boolean;
  transcript_unavailable_reason?: string | null;
}

export interface AssistantDeskResponse {
  generated_at: string;
  stale: boolean;
  buckets: {
    needs_you: AssistantDeskWorkItem[];
    working: AssistantDeskWorkItem[];
    done_recently: AssistantDeskWorkItem[];
  };
  summary: {
    needs_you_count: number;
    working_count: number;
    done_recently_count: number;
    stale_count: number;
  };
}

export interface AssistantDeskTranscriptArtifactRef {
  id?: string;
  label: string;
  source?: string;
  path?: string;
...
export interface AssistantDeskTranscriptEvent {
  id: string;
  at: string;
  at_ms?: number;
  role?: string;
  ...
  text?: string;
  actor_label?: string;
  actor_kind?: "human" | "execass" | "worker" | "tool" | "system" | string;
  event_kind?:
    | "message"
    | "tool_call"
    | "tool_result"
  ...
  artifact_refs?: AssistantDeskTranscriptArtifactRef[];
}

export interface AssistantDeskTranscriptResponse {
  transcript_id: string;
  work_item_id: string;
  title?: string;
  generated_at?: string;
  events: AssistantDeskTranscriptEvent[];
  artifacts?: AssistantDeskTranscriptArtifactRef[];
  complete: boolean;
  next_cursor: string | null;
}
