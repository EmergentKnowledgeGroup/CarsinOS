...
const HELP_COPY: Record<HelpTab, HelpCopy> = {
  ...
  assistant: {
    title: "Your Office desk",
    summary:
      "This is your Office. Read the briefing, ask for anything in the ask box, and decide the few items waiting on you.",
    examples: [
      "Type a request in the ask box — real work becomes a delegation with receipts you can check later.",
      "Items under 'Needs you' ask once, state the consequence, and act on your answer.",
      "Open the Assistant's Desk when you want a longer back-and-forth conversation.",
    ],
  },
  window: {
    title: "Watch without interrupting",
    summary:
      "A calm look at the floor. Busy crabs on the Reef mean real observed work; Office Chatter follows safe progress notes.",
    examples: [
      "A busy crab means real observed work; a quiet one never means offline.",
