...
export const DEFAULT_OPSUX_RUNTIME_CONFIG: OpsUxRuntimeConfig = {
  ...
  safety: {
    // Approved defaults from operator guidance. The old high-burst and
    // cooldown timers are gone: automatic incident posture is composed
    // from authoritative facts, not event volume windows.
