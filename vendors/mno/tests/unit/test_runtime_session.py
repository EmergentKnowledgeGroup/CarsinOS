    ...
    class DistributedSupportRetriever:
        ...
        def retrieve(self, query: str, *, continuity_store: ContinuityStore | None = None) -> RetrievalResult:
            ...
            return RetrievalResult(
                ...
                scored_atoms=[
                    RetrievalScoredAtom(atom=self._atoms["lead"], score=0.59, lexical=0.24, semantic=0.22, sequence=0.0, temporal=0.0, graph=0.0, continuity=0.0),
                    RetrievalScoredAtom(atom=self._atoms["drift"], score=0.51, lexical=0.20, semantic=0.21, sequence=0.0, temporal=0.0, graph=0.0, continuity=0.0),
                    RetrievalScoredAtom(atom=self._atoms["catch22"], score=0.50, lexical=0.19, semantic=0.20, sequence=0.0, temporal=0.0, graph=0.0, continuity=0.0),
                ],
            )
