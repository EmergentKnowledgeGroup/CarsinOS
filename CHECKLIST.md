...
- [ ] `O6` Execute 7-day Telegram/Discord soak and publish resilience report (reconnect, retry, message integrity, approval round-trip). Harness/runbook published: `scripts/channel_soak_runner.py`, `docs/channels/CHANNEL_SOAK_RUNBOOK.md`; pending live owner-input execution/signoff.
